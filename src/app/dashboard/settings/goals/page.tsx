...
const inputClass = "min-h-11 w-full border border-white/[0.12] bg-bg-primary px-3 text-base text-text-primary outline-none focus:border-accent-teal";
