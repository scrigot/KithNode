...
export default function PrepWorkspace({ contactId, contactName }: { contactId: string; contactName: string }) {
  ...
  return (
    <div className="grid gap-4 py-5 xl:grid-cols-[minmax(0,1fr)_340px]">
      <section className="border border-white/[0.08] bg-card p-5">
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button type="button" onClick={() => generate({ force: true })} disabled={loading} className="inline-flex items-center gap-1.5 border border-white/10 px-3 py-2 text-xs disabled:opacity-50"><RefreshCw size={13} className={loading ? "animate-spin" : ""} />Regenerate</button>
